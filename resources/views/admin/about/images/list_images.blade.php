            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Management About's Images</h4>
                                    ...
                                    <table id="tech-companies-1" class="table focus-on">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-priority="3" id="tech-companies-1-col-4">About's Image</th>
                                        ...
                                        <tbody>
                                            @foreach ($listMultiImages as $key => $images)
                                                <tr>
                                                    ...
                                                    <td data-org-colspan="1" data-priority="1"
                                                        ...
                                                        <img class="img-thumbnail" alt="200x200" width="200"
                                                            src="{{ asset('upload/admin_images/' . $images->multi_image) }}"
                                                            data-holder-rendered="true">
                                                    </td>

                                                    <td data-org-colspan="1" data-priority="3"
                                                        data-columns="tech-companies-1-col-5">{{ $images->created_at }}
                                                    </td>
                                                    <td data-org-colspan="1" data-priority="6"
                                                        data-columns="tech-companies-1-col-6">{{ $images->updated_at }}
                                                    </td>
                                                    <td data-org-colspan="1" data-priority="6"
                                                        data-columns="tech-companies-1-col-7"
                                                        class="dt-buttons btn-group flex-wrap">
                                                        <a class="btn btn-info" title="Edit"
                                                            href="{{ route('images.edit', [$images->id]) }}">
