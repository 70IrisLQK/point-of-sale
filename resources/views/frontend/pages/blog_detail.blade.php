                    ...
                    <div class="col-lg-8">
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <img src="{{ asset('upload/admin_images/' . $getBlogById->image) }}" alt="">
                            </div>
                            <div class="blog__details__content services__details__content">
                                <ul class="blog__post__meta">
                                    <li><i class="fal fa-calendar-alt"></i>
                                        {{ Carbon\Carbon::parse($getBlogById->created_at)->diffForHumans() }}
                                    </li>
                                    <li><i class="fal fa-comments-alt"></i> <a href="#">Comment (08)</a></li>
                                    <li class="post-share"><a href="#"><i class="fal fa-share-all"></i> (18)</a></li>
                                </ul>
                                <h2 class="title">{{ $getBlogById->title }}</h2>
                                <h2 class="title">{!! $getBlogById->description !!}</h2>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <aside class="blog__sidebar">
                            ...
                            <div class="widget">
                                ...
                                <ul class="rc__post">
                                    @foreach ($getBlogRecent as $blogRecent)
                                        <li class="rc__post__item">
                                            <div class="rc__post__thumb">
                                                <a href="{{ route('blogs.show', [$blogRecent->id]) }}">
                                                    <img src="{{ asset('upload/admin_images/' . $blogRecent->image) }}"
                                                        alt="">
                                                </a>
                                            </div>
                                            <div class="rc__post__content">
                                                <h5 class="title"><a
                                                        href="{{ route('blogs.show', [$blogRecent->id]) }}">{{ $blogRecent->title }}</a>
                                                </h5>
                                                <span class="post-date"><i class="fal fa-calendar-alt"></i>
                                                    {{ Carbon\Carbon::parse($blogRecent->created_at)->diffForHumans() }}
                                                </span>
                                            </div>
                                        </li>
                                    @endforeach
